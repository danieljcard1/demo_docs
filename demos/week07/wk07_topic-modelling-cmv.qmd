...
This week we're exploring topic modelling with the goal of continuing our discussion of the relationship between interpretive work and computational processes in rhetorical-computational inquiry. We read . 
...
![Results of searchK process](plots/prior/searchk_5-75.png)
...
model_k18 <- stm(documents = dfm_stm$documents,
         vocab = dfm_stm$vocab, 
         K = 18,
         verbose = TRUE)
